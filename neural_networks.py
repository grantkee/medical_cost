...
def design_model(features):
  ...
  # loss = measure of learning success. using "Mean Squared Error"
  # observe the progress of the "Mean Absolute Error" to see how far
  # off from the true values of the units that are being predicted
